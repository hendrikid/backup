...
<html>
    ...
    <head>
        ...
        <title>TK Tarbiyatul Fallah | Laporan</title>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <li>
                        <a href="dashboard-pimpinan.php"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="20" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                            ...
                            <div class="col-xl-12">
                                <div class="card text-white bg-light border-dark">
                                    <div class="container card-body text-dark text-center">
                                        <div class="card-body">
                                            <form action="cetak_laporan.php" method="GET"> 
                                                <div class="bg-transparent p-2 border-dark" style="margin-bottom: 1%; border-radius: 15px 50px 30px 5px;">
                                                    <h3 class="text-center" style="margin-top: 1%;">LAPORAN</h3>
                                                    <hr class="mb-2 mt-0 d-inline-block mx-auto container col-md-8" style="width: 60px; background-color: black; height: 2px;"/>
                                                    <div class="form-group col-md-12 row p-2">
                                                        <label class="col-md-4">Pilih Bulan</label>
                                                        <select class="col-md-4 form-control" name="bulan">
                                                    ...
                                                    <div class="form-group col-md-12 row p-2">
                                                        <label class="col-md-4">Pilih Tahun</label>
                                                        <select class="col-md-4 form-control" name="tahun">
                                                        <?php
                                                            $mulai= date('Y') - 50;
                                                    ...
                                                    <div class="form-group col-md-12 row p-2">
                                                        ...
                                                        <input type="submit" class="btn btn-primary form-control col-md-4" value="CETAK" style="font-size: 20px;">
                                                    </div>
