                            ...
                            <div class="col-xl-12">
                                <div class="card text-white bg-light border-dark">
                                    <div class="card-body text-dark text-center">
                                        <div class="card-body">
                                                <h3 class="text-center" style="margin-top: 1%;">HASIL UJIAN</h3>
                                                <hr class="mb-2 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: black; height: 2px;"/>
                                                <div class="table-responsive">
                                                    <?php 
                                                        include 'koneksi.php';
                                                        $no = 1;
                                                        $query = mysqli_query($koneksi,"SELECT hasil_ujian.id_ujian, pendaftar.nama_lengkap, hasil_ujian.jawaban_benar, hasil_ujian.jawaban_salah, hasil_ujian.jawaban_kosong, hasil_ujian.nilai FROM hasil_ujian INNER JOIN pendaftar ON hasil_ujian.id_pendaftar=pendaftar.id_pendaftar");
                                                    ...
                                                    <table class="table table-striped border text-left table-hover datatab">
                                                        <thead>
                                                            ...
                                                            <th scope="col">Tidak Terjawab</th>
                                                            ...
                                                            <?php
                                                                while($d = mysqli_fetch_array($query)){
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $d['jawaban_salah']; ?></td>
                                                                        <td><?php echo $d['jawaban_kosong']; ?></td>
