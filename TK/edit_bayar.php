                                            ...
                                            <div class="card bg-transparent p-2 border-dark" style="margin-bottom: 1%; border-radius: 15px 50px 30px 5px;">
                                                <div class="col-md-12">
                                                    <?php 
                                                        ...
                                                        $nama_gambar = $_GET['id_bayar'];

                                                        $query = mysqli_query($koneksi, "SELECT * FROM pembayaran where id_bayar='$nama_gambar'");
                                                        $hasil = mysqli_fetch_array($query);

                                                    ?>
                                                            <h3 class="text-center" style="margin-top: 1%;">UBAH BUKTI BAYAR</h3>
                                                            <hr class="mb-2 mt-0 d-inline-block mx-auto container col-md-8" style="width: 60px; background-color: black; height: 2px;"/>
                                                            <form method="post" enctype="multipart/form-data" action="auth_edit_bayar.php">
                                                                <input type="text" value="<?php echo $hasil['id_bayar'] ?>" name="id_bayar" hidden>
                                                                <input type="text" value="<?php echo $hasil['bukti_bayar'] ?>" name="nama_lama" hidden>
