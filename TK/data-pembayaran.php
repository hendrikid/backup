    ...
    <body style="background-image: url(image/bg-1.png); background-size:inherit;">
        ...
        if (isset($_GET['pesan'])) {
            ...
            $( document ).ready(function() {
                swal({
                    title: '<h5>Pembayaran dikonfirmasi.</h5>',
                    type: 'success',
                            ...
                            <div class="col-xl-12">
                                <div class="card text-white bg-light border-dark">
                                    <div class="card-body text-dark text-center">
                                        <div class="card-body">
                                                <h3 class="text-center" style="margin-top: 1%;">PEMBAYARAN BARU</h3>
                                                <hr class="mb-2 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: black; height: 2px;"/>
                                                <div class="table-responsive">
                                                    <?php 
                                                        include 'koneksi.php';
                                                        $no = 1;
                                                        $query = mysqli_query($koneksi,"SELECT pembayaran.id_bayar, pendaftar.nama_lengkap, pembayaran.tgl_bayar, pembayaran.bukti_bayar FROM pembayaran INNER JOIN pendaftar ON pembayaran.id_pendaftar=pendaftar.id_pendaftar WHERE pembayaran.status='Menunggu Konfirmasi'");
                                                                ...
                                                                while($d = mysqli_fetch_array($query)){
                                                                    ...
                                                                    if($d['id_bayar']=='NULL'){
                                                                        ...
                                                                        echo "<tr>";
                                                                            ...
                                                                            echo "<td>$d[id_bayar]</td>";
                                                                            echo "<td>$d[nama_lengkap]</td>";
                                                                            echo "<td>$tgl_bayar</td>";
                                                                            echo "<td>$d[bukti_bayar]</td>";
                                                                            echo "<td class'row'>";
                                                                                echo "<a href='auth_pembayaran.php?id=$d[id_bayar]' class='btn btn-primary form-control col-md-6'>KONFIRMASI</a>";
                                                                                echo "<span> </span>";
                                                                                echo "<a href='' class='btn btn-secondary form-control col-md-5' data-toggle='modal' data-target='#myModal$d[id_bayar]'>LIHAT</a>";
                                                                            echo "</td>";
                                                                        echo "</tr>";
                                                                        ?>
                                                                            <!-- Modal Login -->
                                                                            <div class="modal" id="myModal<?php echo $d['id_bayar']; ?>">
                                                                                <div class="modal-dialog">
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <?php
                                                                                            $id_bayar = $d['id_bayar'];
                                                                                            $query1 = mysqli_query($koneksi,"SELECT * FROM pembayaran WHERE id_bayar='$id_bayar'");
                                                                                            $hasil_bukti = mysqli_fetch_array($query1);
                                                                                        ?>
                                                                                            <img src="pembayaran/<?php echo $hasil_bukti['bukti_bayar']; ?>" class="container" style="width: 100%; height: 500px">
                                                                                        </div>                
                                                                                    </div>
                                                                                </div>
                                                                            </div>
